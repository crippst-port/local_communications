 ...
 * when more than one applies to a given course (see local_feedback_extend_navigation_course()
...
$PAGE->set_url(new moodle_url('/local/feedback/course_campaigns.php', ['courseid' => $courseid]));
...
echo html_writer::start_tag('ul', ['class' => 'local-feedback__campaign-list']);
foreach ($campaigns as $campaign) {
    $url = new moodle_url('/local/feedback/course_report.php', ['courseid' => $courseid, 'campaignid' => $campaign->id]);
